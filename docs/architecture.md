...
Claude Code loads project configuration from the repository root and `.claude/` according to the upstream `[.claude` directory reference]([https://code.claude.com/docs/en/claude-directory.md](https://code.claude.com/docs/en/claude-directory.md)). Skills under `.claude/skills/*/SKILL.md` are the primary workflow surface (slash commands merged into skills).
