...
4. Write a **short, self-contained prompt** in the UI that names the skill or script to run (e.g. invoke the `weekly-sync-deck` skill for the weekly PPTX deck—see [`docs/presentations.md`](docs/presentations.md)) and attach only the **connectors** you need (Linear, Supabase, Google Drive, etc.).
